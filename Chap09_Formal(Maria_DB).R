...
drv <- JDBC(driverClass="com.mysql.jdbc.Driver", 
            classPath="C:\\ITWILL\\2_Rwork\\mysql-connector-java-5.1.46\\mysql-connector-java-5.1.46\\mysql-connector-java-5.1.46-bin.jar")
...
# table -> 처리 -> file name
getwd()
write.csv(goods, "goods.csv", quote = T, row.names = T)
...
dbWriteTable(conn, name = "goods_manager", goods)
