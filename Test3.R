...
CO2non <- subset(CO2, Treatment == "nonchilled")
CO2non
write.csv(CO2non, "CO2_df1.csv")

# 단계2) Treatment 칼럼 값이 'chilled'인 경우만 'CO2_df2.csv' 파일로 저장 
CO2chil <- subset(CO2, Treatment == "chilled")
CO2chil
write.csv(CO2chil, "CO2_df2.csv")
